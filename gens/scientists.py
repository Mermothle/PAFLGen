...
def scientistGen():
    ...
    #personality = genPersonality[scientistPile(genPersonality)]
    ...
    #opinion = genOpinion[scientistPile(genOpinion)]
...
#genPersonality = ["kindness", "contempt", "pity", "disgust", "worry", "sadness", "anxiety", "sympathy", "confusion", "interest", "curiosity"]
...
#genOpinion = ["get on your nerves more and more.", "elicit a lot of sympathy from you.", "are just subjects in your eyes.", "make you feel like a monster.", "are a sore point for you.", "are people you get attached to too quicky.", "make you feel sick on sight."]
